...
public class RedisUtil {
    ...
    public Boolean hPutAndExpire(String key, String hashKey, String value, long timeout, TimeUnit unit) {
        Boolean boo = stringRedisTemplate.opsForHash().putIfAbsent(key, hashKey, value);
    ...
    public Long pfAdd(String key, String value) {
        return this.stringRedisTemplate.opsForHyperLogLog().add(key, value);
    }
    ...
    public Long pfCount(String key) {
        return this.stringRedisTemplate.opsForHyperLogLog().size(key);
    }
}
