...
public class CodeGenerate {
    public static void main(String[] args) {
        ...
        tables.add("acl_role");
        tables.add("acl_user");
        tables.add("acl_user_role");
        tables.add("acl_permission");
        tables.add("acl_role_permission");

        // 项目路径
        String projectPath = "E:\\BootProject\\guli_parent\\service\\service_acl";
